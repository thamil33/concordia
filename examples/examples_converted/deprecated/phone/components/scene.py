...
from environment.deprecated import orchestrator as orchestrator_lib
from examples.deprecated.phone.components import apps
from examples.deprecated.phone.components import logging
from language_model import language_model
from thought_chains.deprecated import thought_chains
from typing_custom.deprecated import agent
...
def build(
  ...
  return orchestrator_lib.GameMaster(
      model=model,
      memory=memory,
      clock=clock,
